...
nVar=97;       % Number of Decision Variables
...
for i=1:nPop
    ...
    featCol = find(pop(i).Position);
    core_gmm_ubm;
    pop(i).Cost = eer; pop(i).Out = dcf1;
    
end

% Sort Population 
% Need to use 2 parameters !!!
Costs=[pop.Cost;pop.Out]';
[Costs, SortOrder]=sortrows(Costs);
pop=pop(SortOrder);
